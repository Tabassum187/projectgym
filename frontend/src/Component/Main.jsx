 ...
 const fetchStatsData = async (email) => {
  ...
  try {
    ...
    setStatsData({
      ...
      workouts: [8, 7],
      weight: [
        { date: '1 Jan', value: 85.8 },
        { date: '15 Jan', value: 90.5 },
        { date: '1 Feb', value: 70.8 }
      ],
      water: {
        current: 580,
        goal: 980
        ...
        <h3 className="mb-0 font-weight-bold mt-2 text-white">
          {isLoading ? '...' : '-1.2 kg'}
                    ...
                    <div className="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                      <div className="card bg-dark">
                        <div className="card-body text-center">
                          <h5 className="mb-2 text-light font-weight-normal">Progress Score </h5>
                          <h2 className="mb-4 text-white font-weight-bold">
                            {isLoading ? '...' : (statsData?.water?.current || 0)} 
                          </h2>
                          <div style={{ height: '150px' }}>
                            {isLoading ? (
                              <div className="d-flex justify-content-center align-items-center h-100">
                          ...
                          <h3 className="mb-0 font-weight-bold mt-2 text-white">
                            {isLoading ? '...' : (statsData?.water?.goal || 580)} 
                          </h3>
                        </div>
                      </div>
                    </div>
...
<div className="row">
      <div className="col-12 grid-margin">
        <div className="card bg-dark recent-activity-card">
          <div className="card-body">
            <h4 className="card-title text-warning mb-4">Recent Activity</h4>
              ...
              <table className="table table-dark table-hover align-middle">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Workout - Morning Run</td>
                    <td><span className="badge bg-primary">Cardio</span></td>
                    <td>5.2 km in 28:15</td>
                  </tr>
                  <tr>
                    <td>Yesterday, 07:15 PM</td>
                    <td>Workout - Chest & Triceps</td>
                    <td><span className="badge bg-success">Strength</span></td>
                    <td>12 exercises, 45 min</td>
                  </tr>
                  <tr>
                    <td>Yesterday, 12:30 PM</td>
                    <td>Nutrition - Lunch</td>
                    <td><span className="badge bg-info text-dark">Nutrition</span></td>
                    <td>Grilled chicken, rice, veggies - 650 kcal</td>
                  </tr>
                  <tr>
                    <td>2 days ago, 06:45 AM</td>
                    <td>Progress - Yoga Session</td>
                    <td><span className="badge bg-warning text-dark">Flexibility</span></td>
        ...
        <div className="row">
          <div className="col-md-3 col-6 mb-4">
            <Link 
              ...
              style={{ paddingTop: '8px', paddingBottom: '8px', color: 'white' }}
              onMouseOver={e => e.currentTarget.style.backgroundColor = '#007bff'}
              onMouseOut={e => e.currentTarget.style.backgroundColor = 'transparent'}
            >
              <i className="mdi mdi-dumbbell icon-lg" style={{ color: 'white' }}></i>
              <span className="d-block mt-2" style={{ color: 'white' }}>Add Workout</span>
            </Link>
          </div>
          <div className="col-md-3 col-6 mb-4">
            <Link 
              ...
              onMouseOut={e => e.currentTarget.style.backgroundColor = 'transparent'}
            >
              <i className="mdi mdi-food icon-lg" style={{ color: 'white' }}></i>
              <span className="d-block mt-2" style={{ color: 'white' }}>Log Meal</span>
            </Link>
          </div>
          <div className="col-md-3 col-6 mb-4">
            <Link 
              ...
              onMouseOut={e => e.currentTarget.style.backgroundColor = 'transparent'}
            >
              <i className="mdi mdi-ruler icon-lg" style={{ color: 'white' }}></i>
              <span className="d-block mt-2" style={{ color: 'white' }}>Add Reminders</span>
            </Link>
          </div>
          <div className="col-md-3 col-6 mb-4">
            <Link 
              ...
              onMouseOut={e => e.currentTarget.style.backgroundColor = 'transparent'}
            >
              <i className="mdi mdi-flag-checkered icon-lg" style={{ color: 'white' }}></i>
              <span className="d-block mt-2" style={{ color: 'white' }}>Set Goal</span>
            </Link>
          </div>
        </div>
      </div>
